...
def refine_support_images(support_dir: str, refined_dir: str, yolo, conf=0.01):
...
def process_video_pipeline(
    ...
    tracker = Tracker(max_age=tracker_max_age, emb_threshold=sim_threshold, lambda_emb=0.3, lambda_iou=0.7)
...
if __name__ == '__main__':
    ...
    TOTAL_OUTPUT_DIR = Path(f'/mlcv2/WorkingSpace/Personal/quannh/Project/Project/ZaloAI2025/src/idea/{TYPE}2_updetr_mobileclip2_tracker')
